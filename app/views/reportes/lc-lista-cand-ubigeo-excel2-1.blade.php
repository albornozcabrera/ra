...
<table border="1">
    ...
    <tr>
        <td></td>
        <td colspan="4" align="center" style="vertical-align:middle;font-size: 150" width="200" height="30"><strong>LISTA DE CANDIDATOS POR UBIGEO - ORGANIZACIONES CON LISTAS Y SUS CANDIDATOS</strong></td>
        <td></td>
    </tr>
</table>
...
<table class="table-report-excel" >
  ...
  <tr style="color: #FFFFFF" >
  		<td colspan="2" align="center"  style="background-color:#538DD5; color:#FFFFFF"><strong>{{ $col->nro }}</strong></td>
        ...
        <td colspan="2" align="center"  style="background-color:#538DD5; color:#FFFFFF"><strong>{{ $col->resolucion }}</strong></td>
    				 ...
    				 <tr>
                        ...
                        <td align="center" style="background-color:#C5D9F1; color:#000000"><strong>PROVINCIA</strong></td>
                     ...
                     @foreach ($col->ListaCand as $col2)
                      <tr>
                        ...
                        <td align="center">{{ $col2->participa }}</td>
