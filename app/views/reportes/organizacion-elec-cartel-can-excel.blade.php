...
<body>
    ...
    header("Content-Disposition: attachment; filename= ListOrgxEleccionParaCartelCand.xls");
    ...
    <table border="1">
        ...
        <tr>
            <td></td>
            <td></td>
            <td colspan="7" align="center" style="vertical-align:middle;font-size: 150" width="200" height="30"><strong>ORGANIZACIONES POLÍTICAS POR ELECCIÓN PARA CARTEL DE CANDIDATOS</strong></td>
            <td></td>
            <td></td>
        </tr>
    </table>
